...
```{r ima2, eval=TRUE}
knitr::include_graphics("presentacion_proyecto_files/imagenes/domain.png", out.width="40%", out.height = "40%")
```
...
![](presentacion_proyecto_files/imagenes/protein.png){width=30px height=30px}
